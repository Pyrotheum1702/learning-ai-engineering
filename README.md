...
| [learning-python](projects/learning-python/) | 🟨 | 20 build-it-yourself Python projects, easy → hard (8/20 done — Tier 1 complete, Tier 2 in progress). **All code hand-written** — AI used only as a tutor, never to generate solutions. Fundamentals → data & persistence → real-world tooling → systems, async & packaging. |
